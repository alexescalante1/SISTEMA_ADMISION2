...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">INGRESANTES</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="inicio">INICIO</a></li>
            <li class="breadcrumb-item active">INGRESANTES</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                                        ...
                                        <table id="tablaEvAdmi" class="table table-bordered table-striped">
                                            ...
                                            <?php
                                                    ...
                                                    foreach ($admicion as $key => $value) {
                                                        $accionesFinal = "<div class='btn-group'><a href='".$admicion[$key]["ruta"]."-ingresantes'><button class='btn btn-block btn-success'><i class='fa fa-eye'></i></button></a></div>";
                                                        echo '
                                                        <tr>
                                                            <td>'.$accionesFinal.'</td>
