...
class AjaxAdministradores{
	...
	public function  ajaxElimAdmin(){
		...
		$respuesta = ControladorAdministradores::ctrEliminarAdmin($datos);
...
ELIMINAR EJERC
=============================================*/
if(isset($_POST["idEliAdminA"])){

	$elimSl = new AjaxAdministradores();
	$elimSl -> idPerfil = $_POST["idEliAdminA"];
	$elimSl -> fotoPerfil = $_POST["fotoPerfilA"];
	$elimSl -> ajaxElimAdmin();
